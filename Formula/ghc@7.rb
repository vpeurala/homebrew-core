...
class GhcAT7 < Formula
  include Language::Haskell::Cabal

  desc "Glorious Glasgow Haskell Compilation System"
  homepage "https://haskell.org/ghc/"
  url "https://downloads.haskell.org/~ghc/7.10.3/ghc-7.10.3-src.tar.xz"
  sha256 "cf90cedce1c28fd0e2b9e72fe8a938756668d18ea1fcc884a19f698658ac4fef"
  ...
  head do
    url "https://git.haskell.org/ghc.git", :branch => "ghc-7.10"
  ...
  resource "gmp" do
    url "https://ftp.gnu.org/gnu/gmp/gmp-5.1.3.tar.xz"
    mirror "https://gmplib.org/download/gmp/gmp-5.1.3.tar.xz"
    mirror "https://ftpmirror.gnu.org/gmp/gmp-5.1.3.tar.xz"
  ...
  # https://www.haskell.org/ghc/download_ghc_7_10_3#macosx_x86_64
